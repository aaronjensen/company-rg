...
;; Copyright (C) 2020-2021 Aaron Jensen

;; Author: Aaron Jensen
;; URL: https://github.com/aaronjensen/company-rg
;;
;; Version: 1.0
;; Keywords: company
;; Package-Requires: ((emacs "27.1") (company "0.9.0") (dash "2.2.0"))
...
;;; Commentary:
;; A Company backend that uses rg.
